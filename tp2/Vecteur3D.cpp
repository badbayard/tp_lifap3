...
{
	cout <<"frame de la variable vect " <<(long int) &vect <<endl;
	
	vect->x=vect->x/Vecteur3DGetNorme(*vect);

	cout<<" adresse de vect.x " <<(long int)&vect->x<<endl;
	
	vect->y=vect->y/Vecteur3DGetNorme(*vect);
	
	cout<<"adresse de vect.y" <<(long int) &vect->y<<endl;

	vect->z=vect->z/Vecteur3DGetNorme(*vect);

	cout<<"adresse de vect.z" <<(long int)&vect->z<<endl;
}
...
int main ()
{
 ...
 cout << endl;
	...
	cout<<"frame de vecteur3dafficher " << &vecteur1<<endl;
	cout<<" la taille de vecteur est : " <<sizeof(vecteur1)<<endl;
...
// Vecteur3DAfficher (vecteur2);
 ...
 cout<<"frame de vecteur3DNormaliser " << &vecteur1 <<endl;

 Vecteur3DNormaliser(&vecteur2);

 cout << " frame de vecteur3DNormaliser " <<&vecteur2 <<endl;
